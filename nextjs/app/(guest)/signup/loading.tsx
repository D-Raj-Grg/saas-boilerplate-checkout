    ...
    <div className="flex h-screen">
      ...
      <div className="flex w-full items-center justify-center bg-background lg:w-1/2">
        <div className="mx-auto w-full max-w-sm space-y-6">
          {/* Card Header */}
          <div className="bg-card p-8 rounded-md shadow-2xl space-y-6">
            <div className="space-y-2">
              <Skeleton className="h-8 w-56" /> {/* Create Account */}
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Skeleton className="h-4 w-16" /> {/* Last Name */}
                  <Skeleton className="h-10 w-full" />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <Skeleton className="h-10 w-full" /> {/* Create Account button */}
            </div>

            {/* Footer */}
            <div className="text-center">
              <Skeleton className="h-4 w-56 mx-auto" /> {/* Already have account */}
            </div>
          </div>
        </div>
      </div>
