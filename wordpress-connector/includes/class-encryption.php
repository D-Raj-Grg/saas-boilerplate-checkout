...
class Encryption
{
    ...
    protected function get_default_key()
    {
        ...
        if (defined('SURECRM_ENCRYPTION_KEY') && '' !== SURECRM_ENCRYPTION_KEY) {
            return SURECRM_ENCRYPTION_KEY;
        }
    ...
    {
        if (defined('SURECRM_ENCRYPTION_SALT') && '' !== SURECRM_ENCRYPTION_SALT) {
            return SURECRM_ENCRYPTION_SALT;
        }
